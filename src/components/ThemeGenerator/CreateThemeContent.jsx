...
const CreateThemeContent = props => {
  ...
  const defaultTheme = {
    ...
    "imageBanner":"./variables/assets/banner_img.svg",
    "titleBanner":"Titre de la bannière",
    "subTitleBanner":"Sous titre de la bannière"        
  }
  ...
  const getThemeObj = () => {
    ...
    themeObj[_.camelCase(state.themeName)] = {
      ...
      "banner": {
          ...
          "titleBanner": state.titleBanner,
          "subTitleBanner": state.subTitleBanner
        }
    };
    return themeObj
  }
    ...
    <Container>
      ...
      <Section>
        ...
        <Row>
          ...
          <input 
            type="color" 
            id="txt_color_primary" 
            name="txtColorPrimary" 
            value={ state.txtColorPrimary } 
            onChange={ handleChange }
          />
        </Row>
        <Row>
        ...
        <Row>
          ...
          <input 
            type="color" 
            id="txt_color_secondary" 
            name="txtColorSecondary" 
            value={ state.txtColorSeconday } 
            onChange={ handleChange }
          />
        </Row>
        <Row>
          ...
          <input 
            type="color" 
            id="btn_bg_color_primary" 
            name="btnBgColorPrimary" 
            value={ state.btnBgColorPrimary } 
            onChange={ handleChange }
          />
        </Row>
        <Row>
      ...
      <Section>
        ...
        <Row>
          <label htmlFor="title_banner">Title</label> {' '}
          <input 
            type="text" 
            id="titleBanner" 
            name="titleBanner" 
            value={ state.titleBanner }
            placeholder="Specify Title section" 
            onChange={ handleChange }
          />
        </Row>
        <Row>
          <label htmlFor="subTitle_banner">Subtitle</label> {' '}
          <input 
            type="text" 
            id="subTitleBanner" 
            name="subTitleBanner" 
            value={ state.subTitleBanner }
            placeholder="Specify Subtitle section" 
            onChange={ handleChange }
          />
        </Row>
        <Row>
          <label htmlFor="image_banner">Image Banner</label> {' '}
          <input type="file" accept ="image/*" onChange ={handleChangeImg}/>
          <div  style={{height:"80px",width:"100%", background:"url()"}}>
